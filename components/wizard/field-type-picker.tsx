...
const tileClassName =
  "group flex flex-col items-center gap-2 rounded-2xl border border-border bg-card px-3 py-4 text-center outline-none transition-all hover:-translate-y-0.5 hover:border-primary/50 hover:shadow-md focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50";
const tileIconClassName =
  "flex size-9 items-center justify-center rounded-full bg-primary/15 text-ink transition-colors group-hover:bg-primary";
